...
<input type="hidden" name="newsID" value=<? print("\"" . $newsID . "\""); ?> >
...
<input type="hidden" name="id" <? print("value='" . $id . "'"); ?> />
Rarity Roll: <input type="text" name="rareroll" <? print("value='" . $rareRoll . "'"); ?> /> <br />(Number of sides the Drop Rate dice has)<br /><br />
Item Name: <input type="text" name="itemName" <? print("value='" . $name . "'"); ?>/><br />
Item Description: <input type="text" name="itemDescribe" <? print("value='" . $description . "'"); ?>/><br />
Item Image: <input type="text" name="itemimage" <? print("value='" . $image . "'"); ?>/> <br />(Please use it in this format: images/items/item.png) <a href='images/items/' target="_blank">Click Here For List (Opens new window)</a><br /><br />
Item Type: <input type="text" name="itemtype" <? print("value='" . $type . "'"); ?>/> <br /><a href="index.php?page=cp&cpage=itemTypes" target="_blank">Click Here for list (Opens new Window)</a><br /><br />
Action Points: <input type="text" name="itemAP" <? print("value='" . $AP . "'"); ?>/> <br />(How much the effect of the item has, HP = Health Restored, Weapon=Damage, etc.)<br /><br />
Is Buffed: <input type="checkbox" name="isbuffed" <? print("value='" . $isbuffed . "'"); ?>/> <br />(If it isn't buffed you dont have to go on, just leave it as it is)<br /><br />
Buff Name: <input type="text" name="buffName" <? print("value='" . $buffimage . "'"); ?>/> <br />
Buff Image: <input type="text" name="buffImage" <? print("value='" . $buffname . "'"); ?>/> <br />(Please use it in this format: images/items/item.png) <a href='images/items/' target="_blank">Click Here For List (Opens new window)</a><br /><br />
Buff Battles Left: <input type="text" name="buffBL" <? print("value='" . $battlesleft . "'"); ?>/> <br />(How many battles it has until the buff would expire)<br /><br />
Buff Strength Gained: <input type="text" name="buffSTR" <? print("value='" . $str . "'"); ?>/><br />
Buff Defense Gained: <input type="text" name="buffDEF" <? print("value='" . $def . "'"); ?>/><br />
Buff Max HP Gained: <input type="text" name="buffHP" <? print("value='" . $maxHP . "'"); ?>/><br />
Buff Max MP Gained: <input type="text" name="buffMP" <? print("value='" . $maxMP . "'"); ?>/><br />
<br />
...
$itemid = array('set' => 1);
$itempic = array('set' => 1);
$itemname = array('set' => 1);
$itemdesc = array('set' => 1);
//MySQL Data...
$query = "SELECT * FROM va_users";
$result = mysql_query($query);
$num1 = mysql_numrows($result);
...
<input type="hidden" name="id" <? echo "value='" . $_GET['id'] . "'";?> /><br />
Message<hr />
